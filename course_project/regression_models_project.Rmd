...
In this section both questions mentioned in [the Introduction](#Introduction) are answered based the model built in Section [Methods and results](#methodsResults). Summary of the model is given here.
